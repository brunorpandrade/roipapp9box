// ROIP APP 9BOX — mapeamento canonico Lucide S466 (ME-055 Bloco A).
//
...
//
// Origem canonica: DOC 05 §2.7 (23 itens canonicos, S466 Opcao A).
//
...
// §2.7 — 23 itens canonicos preservados palavra por palavra, na ordem
// exata em que aparecem no DOC 05 §2.7.
...
// §2.7 — mapeamento bit-exact, S466 Opcao A. Chaves na mesma ordem de
// MENU_ITEM_LABELS para auditoria linha a linha.
