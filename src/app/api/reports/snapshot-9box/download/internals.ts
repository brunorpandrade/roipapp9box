...
// `/api/reports/snapshot-9box/download/route.ts` (ME-070, padrao S366).
//
...
//   `./route.ts` (GET).
// - `__setSnapshot9BoxDbClient` + `__setSnapshot9BoxPdfRenderer` +
//   `__setSnapshot9BoxNow` disponibilizados como escape hatch canonico
//   S036/S100/S260 — ainda sem test consumer proprio, alinhamento a
//   S366 preserva superficie completa canonica.
