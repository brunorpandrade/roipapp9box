...
// `/api/reports/clima-engajamento/download/route.ts` (ME-070, padrao
// S366).
//
...
// irmao. Zero mudanca de comportamento, autorizacao (Bearer JWT), SQL
// ou binario PDF.
//
// RV-13: cada export tem chamador:
// - `getDbClient` + `getPdfRendererFacade` + `getNowFn` consumidos por
//   `./route.ts` (GET).
// - `__setClimaDownloadDbClient` + `__setClimaDownloadPdfRenderer` +
